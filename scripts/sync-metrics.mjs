...
const reportLines = [
  ...
  `- Seeded demo observations: ${payload.liveFunnel.fixtureObservationCount}`,
  `- GitHub-synced observations: ${payload.liveFunnel.githubSyncedObservationCount}`,
  `- Verified external GitHub observations: ${payload.liveFunnel.externalObservationCount}`,
  `- Verified external AI PR velocity (7d): ${payload.liveFunnel.externalAiPrVelocity}`,
